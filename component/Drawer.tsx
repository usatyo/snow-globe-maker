...
export const Drawer: FC<Props> = ({ isOpen, titles, childrens }) => {
  ...
  return (
    <div className="md:mt-20 relative  z-20 h-full bg-base-light/10 flex flex-col py-12 px-10 space-y-8 bg-blur-md md:w-[30%] text-center items-center backdrop-blur-sm overflow-y-auto">
